...
import sys
sys.path.append('..')
from utils.calculations import detect_defrost_cycles, calculate_recovery_time
...
if len(defrost_df) > 0:
    ...
    fig = px.bar(defrost_per_day, x='date', y='defrost_count',
                 title="Number of Defrost Cycles per Day")
    ...
    fig = px.scatter(defrost_display, x='start_time', y='duration_minutes',
                    color='max_temp',
