...
if len(cycles_df) > 0:
    ...
    fig = px.bar(cycles_per_day, x='date', y='cycle_count',
                 title="Number of Cooling Cycles per Day")
    ...
    fig = px.histogram(cycles_df, x='duration_minutes', nbins=30,
                      title="Distribution of Cycle Durations")
